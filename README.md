...
## Features implemented based on the project's requirements
- Users are able to add todo items to the app 
- Users are able to check / uncheck todo items in the app
- Users are able to delete todo items
- Todo items count will update accordingly (both when new items are added or deleted)
- Unchecked items count will update accordingly (when new items are added, deleted or user checked / unchecked the todo items)

## Screencast Link Demo
Demo to this project can be found [here](https://youtu.be/8u2RT7PEAjY)
